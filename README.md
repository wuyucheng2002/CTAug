...
| dataset      | IMDB-BINARY      | Dataset name, can be chosen from graph classification: {'IMDB-BINARY', 'IMDB-MULTI', 'REDDIT-BINARY', 'ENZYMES', 'PROTEINS'}, node classification: {'Coauthor-Phy', 'Amazon-Computers'}. |
...
| core         | kcore            | Subgraph property, can be chosen from {'kcore', 'ktruss'}. Only used in CTAug-GRACE and CTAug-GCA methods. |
