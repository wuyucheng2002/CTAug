...
class Model_GSN(nn.Module):
    def __init__(self, n_id, n_in, n_h, num_layers, device):
        super(Model_GSN, self).__init__()
        self.mlp1 = MLP(1 * n_h, n_h)
        self.mlp2 = MLP(num_layers * n_h, n_h)
        self.gnn1 = GCN_GSN(n_id, n_in, n_h, num_layers, device)
        self.gnn2 = GCN_GSN(n_id, n_in, n_h, num_layers, device)
